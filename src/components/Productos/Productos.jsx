          ...
          <div key={producto.slug}>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="rounded-lg bg-blue-600 px-2 py-2.5 text-center text-sm font-medium text-white hover:bg-yellow-500 hover:text-black focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
                >
                  Agregar al carrito
                </a>
              </div>
