    ...
    <div>
        <div className='flex items-center justify-center min-content'>
                <div className='w-10/12 md:w-8/12 lg:w-5/12 py-6 mt-7 mb-28 md:mb-7'>
                  <div className=''>
                      <h1 className="text-4xl text-center sm:text-start font-bold text-sky-950 pb-2">¡Iniciá sesión y accedé!</h1>
                  ...
                  <form className='' onSubmit={handleSubmit}>
                      <div className='flex flex-col py-1'>
                          ...
                          <input onChange={(e) => setEmail(e.target.value)} placeholder='Ingresá tu correo' className='border p-2 rounded' type="email"/>
                      </div>
                      <div className='flex flex-col py-1'>
                      ...
                      <button className='text-xl font-medium bg-blue-600 hover:bg-blue-500 dark:bg-yellow-500 w-full p-3 my-2 text-white rounded'>Iniciar Sesión</button>
                  </form>
                  <p className='py-1 text-sky-950 text-center sm:text-start'>
                          Si no tenés tu cuenta, creá una! <Link to={'/signup'} className='underline text-blue-500'><span className="text-blue-500">Registrarse</span></Link>
                    </p>
                </div> 
